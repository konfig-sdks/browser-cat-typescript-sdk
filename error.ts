...
/**
 * This class provides a wrapper for network errors when making requests to BrowserCat API
 */
export class BrowserCatError extends Error {
  /**
   * The response body
   */
